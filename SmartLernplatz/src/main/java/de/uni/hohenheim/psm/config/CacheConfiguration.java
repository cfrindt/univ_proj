package de.uni.hohenheim.psm.config;
...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("SmartLernplatz");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("SmartLernplatz");
        ...
        config.getMapConfigs().put("de.uni.hohenheim.psm.domain.*", initializeDomainMapConfig(jHipsterProperties));
